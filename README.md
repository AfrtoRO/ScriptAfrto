																																		...
																																		if fastPets and powerName == "Agility" then
																																			...
																																			if isfile("UI/ArrayField.lua") then
																																				...
																																				local Window = Rayfield:CreateWindow({
																																				   Name = "Pet Simulator GUI | by Afrto ",
																																				   LoadingTitle = SCRIPT_NAME .. " " ..SCRIPT_VERSION,
																																				   LoadingSubtitle = "by Afrto",
																																				   ConfigurationSaving = {
																																					  Enabled = true,
																																					  FolderName = "Afrto",
																																										...
																																										writefile("Rafa/AcceptedTerms.txt", "true")
																																											...
																																											if Rayfield and Rayfield.Flags and not Rayfield.Flags[flagName] then
																																												...
																																												if Rayfield and Rayfield.Flags and Rayfield.Flags[flagName] then
																																													...
																																													local stats = autoFarmTab : CreateParagraph({ Title = "Hello, <b><font color=\"#2B699F\">" ..LocalPlayer.DisplayName .. "</font></b>!", Content = "Thanks for using my script! - Afrto\nMake sure to join us at <b><font color=\"#2B699F\">https://t.me/SANT_HACK</font></b>" })
